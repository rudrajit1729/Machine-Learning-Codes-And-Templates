...
'''
Kernel SVM results
Feature Scaling required here without that wont work as the concept requires FS itself
without negation
Accuracy = 0.735
Precision = 0.7155172413793104
Recall = 0.8058252427184466
F1_Score = 0.7579908675799087

with negation(use modif_stop instead of stopwords)
Accuracy = 0.755
